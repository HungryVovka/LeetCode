...
# arranged as "b", "c", "a". "d" can be placed at any position since it's not in order. The 
# output "bcad" correctly follows this rule. Other arrangements like "bacd" or "bcda" 
...
class Solution:
    def customSortString(self, order: str, s: str) -> str:
        sorted_s = sorted(s, key=lambda x: order.index(x) if x in order else len(order))

...
# an integer array tokens, where each tokens[i] donates the value of tokeni.
# 
...
# 
# Face-up: If your current power is at least tokens[i], you may play tokeni, losing 
...
# Output: 1
# 
# Explanation: Play token1 (100) face-up, reducing your power to 50 and increasing your 
# score to 1.
# 
# There is no need to play token0, since you cannot play it face-up to add to your score. The 

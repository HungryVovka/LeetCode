...
-- the answer is 1/3 = 0.33

# Write your MySQL query statement below
SELECT ROUND(AVG(a_next.player_id IS NOT NULL), 2)
AS fraction
FROM (
...
ON a_next.player_id = first_login.player_id
AND a_next.event_date = DATE_ADD(first_login.first_date, INTERVAL 1 DAY);

...
// subtract - This method subtracts the given number value from the result and returns 
// the updated Calculator.
// multiply - This method multiplies the result  by the given number value and returns 
// the updated Calculator.
// divide - This method divides the result by the given number value and returns 
// the updated Calculator. If the passed value is 0, an error "Division by zero is not allowed" 
// should be thrown.
...
class Calculator {
     ...
     */
    power(value){
        this.answer = Math.pow(this.answer, value);
        return this;
    }

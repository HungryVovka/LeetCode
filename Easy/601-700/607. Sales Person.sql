...
-- 
-- Write a solution to find the names of all the salespersons who did not have any orders related to the company with the 
-- name "RED".
-- 
...
-- salesperson John and Pam have sales to company RED, so we report all the other names 
